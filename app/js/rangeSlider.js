 ...
 */
var slider = MultiRangeSlider(document.querySelector(".multi-range"), settings);
 ...
 */
const view = {
  start: document.querySelector(".start-price"),
  end: document.querySelector(".end-price"),
...
view.update({ start: settings.start, end: settings.end });
}